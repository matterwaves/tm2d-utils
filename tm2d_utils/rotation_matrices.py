...
def get_rotation_matrix(angles):
    ...
    in_matrices = np.zeros(shape=(4, 4, angles.shape[0]), dtype=np.float32)
    ...
    in_matrices[0, 0] = m00 * M00 + m10 * M01
    in_matrices[0, 1] = m00 * M10 + m10 * M11
    in_matrices[0, 2] = m00 * M20
    #in_matrices[0, 3] = offsets[0]
    
    in_matrices[1, 0] = m01 * M00 + m11 * M01
    in_matrices[1, 1] = m01 * M10 + m11 * M11
    in_matrices[1, 2] = m01 * M20
    #in_matrices[1, 3] = offsets[1]

    return in_matrices.T
